...
pillar_question: OPS06
title: Employ safe deployment strategies
risk_level: MEDIUM
source_url: >-
  https://docs.aws.amazon.com/wellarchitected/latest/framework/ops_mit_deploy_risks_deploy_mgmt_sys.html
...
Automated deployments balance speed of roll-outs against delivering beneficial changes consistently to customers. Limiting impact prevents costly deployment failures and maximizes teams ability to efficiently respond to failures.
...
![Deployment process flow for Amazon EC2](/images/wellarchitected/latest/framework/images/deployment-process-ec2.png)

![Deployment process flow for Amazon ECS](/images/wellarchitected/latest/framework/images/deployment-process-ecs.png)

![Deployment process flow for Lambda](/images/wellarchitected/latest/framework/images/deployment-process-lambda.png)
